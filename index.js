...
TOKEN = "ya29.a0AXooCgsstkpWS_5lPayHk0caQlj0H-uzm8EWFs3UZ4uEJL9xnwuyOYfHp3H4aZfg5XgIWmqwIkdfZECA27wALf4cYN_PDLHpIbLl-yYJd7S4BpWIBUy2DTSGLDgMTtLyvogTiNWt5sneH1oPiPlO5r6Tr0dWc4UgpDVqpsjR75h4tS_MSzxf_wlYVNH7xot_7-D8FlZWpl9n7AVVawIPAY6RI4pM7gyK8mY90CHrBqQ3jEXpnKvnJ1gykN4-FNFbUrvHP_FKzP69F3rDZhTYOflUyh6TK_PiAm6qbPDruWJ7W9DvR-M0K6ZMF5KzJBR0NI2tTEGfdUSTVq9vsVuCPBOaOLPsF9sSrr24VXtojlREQFP3SCdAMyBp7Rlyx-e_hT9SZe-dkTGLTzzUM6pPvTIkSkjfjakaCgYKAV8SARASFQHGX2MiqwGjUbNXv4Psnx_L9P74NQ0422";
...
function callDialogflowAPI(userMessage) {
    ...
    const apiUrl = `https://global-dialogflow.googleapis.com/v3/projects/search-conversation/locations/global/agents/5cc29132-282c-4028-b1b1-e3e1fab9a7f8/sessions/${SESSION_ID}:detectIntent`;
        ...
        .then(async (data) => {
            ...
            for (const response of botResponse) {
                if (response.text) {
                    ...
                    addMessage("AI: " + translatedText, true);
